...
public class ClientesFormController implements Initializable {
	...
	public void setServices(ClienteService service) {
	...
	private Cliente getFormData() {
		...
		obj.setId_cliente(Utils.tryParseToInt(txtId.getText()));
		obj.setDocumento(txtDocumento.getText());
	...
	private void initializeNodes() {
		...
		//Constraints.setTextFieldInteger(txtDocumento); // Define que somente inteiros serão aceito no txtId
	...
	public void updateFormData() {
		...
		txtId.setText(String.valueOf(entity.getId_cliente()));
		txtName.setText(entity.getNome());
		txtDocumento.setText(entity.getDocumento());
